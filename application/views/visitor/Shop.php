                    ...
                    <div class="left-menu mb-30">
                        <div class="panel">
                            <div class="panel-heading">
                                <a role="button" data-toggle="collapse" href="#<?php echo $mainCategory[0]->categoryId
                                ?>">
                                    <div class="pull-right fa fa-chevron-down"></div>
                                    <h4 class="panel-title"><?php echo $mainCategory[0]->categoryTitle;?></h4>
                                </a>
                            </div>
                            <div id="<?php echo $mainCategory[0]->categoryId?>" class="panel-collapse collapse">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <div class="product-wrapper-content">
                                        <div class="product-details">
                                            <h4><a href="<?php echo site_url().'/visitor/viewBookDetails/?isbn='
                                                    .$book->isbnNo;?>"><?php echo $book->title;?></a></h4>
                                            <h5><a href="<?php echo site_url().'/visitor/viewBookDetails/?isbn='
                                                    .$book->isbnNo;?>">By <?php echo " ".$book->authorName;?></a></h5>
                                            <div class="product-price">
                                                <ul>
                                                    <li>$<?php echo $book->price;?></li>
                                                </ul>
